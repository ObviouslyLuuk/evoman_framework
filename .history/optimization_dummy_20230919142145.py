...
def main(
    ...
    stats = {'generation':[0.0], 'max': [pfit.max()], 'mean': [pfit.mean()], 'std': [pfit.std()], 'min': [pfit.min()]}
    ...
    # save df to file as csv named with experiment name and time. example "experiment1:"
