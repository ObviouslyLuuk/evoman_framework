...
def evaluate(env, pop):
    ...
    # print('single eval: ', simulation(env,pop[0]))
    # print('Eval: ', np.array(list(map(lambda pop: simulation(env,pop), pop))))
...
def main(
    ...
    print(f'>>Win Ratio: {np.where(pfit>50,1,0).mean()*100:.2f} %')

    # print(f'pop={pop}')
    # print(f'pfit={pfit}')
    # print(f'start_gen={start_gen}')
