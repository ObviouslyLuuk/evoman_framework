...
class Environment(object):
    ...
    def fitness_single(self):
        ...
        ReducedL_p = ReducedL_p if E_p_score > 0 else 1000
        E_e_score = 100 - self.get_enemylife() 
        E_e_score = E_e_score if E_e_score > 0 else 1000
        # original
        f = E_p_score if  + E_e_score - numpy.log(self.get_time())

        f = (100 - E_e) + 0.1*E_p - numpy.log(self.get_time())
